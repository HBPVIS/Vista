...
# script to configure and start an application on a generic desktop app
...
./$STARTSCRIPTS_SUBDIR/start.sh $@ -vistaini vista_desktop.ini -displayini display_desktop.ini -clusterini display_desktop.ini
