...
#pragma warning( pop )
	...
	{
		VistaQuaternion qRand( GenerateRandom<float>(), GenerateRandom<float>(), GenerateRandom<float>(), GenerateRandom<float>() );
		qRand.Normalize();
		return qRand;
	}
	...
	{
		return VistaTransformMatrix( GenerateRandom<float>(), GenerateRandom<float>(), GenerateRandom<float>(), GenerateRandom<float>(),
