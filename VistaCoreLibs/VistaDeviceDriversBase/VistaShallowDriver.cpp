...
{
public:
	virtual IVistaDeviceDriver *operator()() { return new VistaShallowDriver(0); }
};
...
/*============================================================================*/
VistaShallowDriver::VistaShallowDriver(unsigned int nMeasureSize)
: IVistaDeviceDriver(),
...
unsigned int VistaShallowDriver::GetSensorMeasureSize() const
{
	return m_nMeasureSize;
}

bool VistaShallowDriver::DoSensorUpdate(microtime dTs)
{
	return true;
}
