...
/*                                                                            */
/*============================================================================*/
// $Id: VistaDriverReferenceFrameAspect.h 22143 2011-07-01 15:07:00Z dr165799 $
...
struct VistaEulerAngles;

/*============================================================================*/
/* CLASS DEFINITIONS                                                          */
/*============================================================================*/
/**
 * still under development. The reference frame query for trackers that support
 * it. One can ask: ok... that is what the DFN is for, and right she is. But
 * some devices support to give a reference frame already in hardware, which
 * can save some cycles during processing, and those should export the reference
