...
public:
	 ...
	 * can return false here. An observerable must only be deleted iff all observes return
	 * true here.
	 ...
	 * data structure which is identifieable by the pointer to the base instance alone.
