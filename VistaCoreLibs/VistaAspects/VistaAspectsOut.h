...
#ifndef _VISTAASPECTSOUT_H
#define _VISTAASPECTSOUT_H

#include <ostream>
#include "VistaAspectsConfig.h"
class VISTAASPECTSAPI VistaAspectsOut
{
public:
...
#define vaspout VistaAspectsOut::out()
#define vasperr VistaAspectsOut::err()
#define vasplog VistaAspectsOut::log()
