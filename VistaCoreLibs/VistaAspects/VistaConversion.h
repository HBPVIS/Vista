...
/*                                                                            */
/*============================================================================*/
// $Id: VistaConversion.h 23043 2011-08-23 14:13:18Z dr165799 $
...
namespace VistaConversion
{
	...
	template<>
	inline bool CreateInitializedDefaultObject()
	{
		return false;
	}
	template<>
	inline char CreateInitializedDefaultObject()
	{
		return char(0);
	}
	template<>
	inline signed char CreateInitializedDefaultObject()
	{
		return char(0);
	}
	template<>
	inline unsigned char CreateInitializedDefaultObject()
	{
		return (unsigned char)0;
	}
	template<>
	inline wchar_t CreateInitializedDefaultObject()
	{
		return (wchar_t)0;
	}
	template<>
	inline short CreateInitializedDefaultObject()
	{
		return (short)0;
	}
	template<>
	inline unsigned short CreateInitializedDefaultObject()
	{
		return (unsigned short)0;
	}
	template<>
	inline int CreateInitializedDefaultObject()
	{
		return (int)0;
	}
	template<>
	inline unsigned int CreateInitializedDefaultObject()
	{
		return (unsigned int)0;
	}
	template<>
	inline long int CreateInitializedDefaultObject()
	{
		return (long int)0;
	}
	template<>
	inline unsigned long int CreateInitializedDefaultObject()
	{
		return (unsigned long int)0;
	}
	template<>
	inline long long int CreateInitializedDefaultObject()
	{
		return (long long int)0;
	}
	template<>
	inline unsigned long long int CreateInitializedDefaultObject()
	{
		return (unsigned long long int)0;
	}
	template<>
	inline float CreateInitializedDefaultObject()
	{
		return (float)0;
	}
	template<>
	inline double CreateInitializedDefaultObject()
	{
		return (double)0;
	}
	template<>
	inline long double CreateInitializedDefaultObject()
	{
