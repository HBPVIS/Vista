...
public:
	 ...
	 */
	bool AddEventHandler(VistaEventHandler *pHandler,
	 ...
	 */
	bool RemEventHandler(VistaEventHandler *pHandler,
						 EVENTTYPE nEventType,
						 EVENTID nEventId);


	int GetPriority(VistaEventHandler *pHandler,
					EVENTTYPE nEventType,
					EVENTID nEventId) const;

	bool SetPriority(VistaEventHandler *pHandler,
					EVENTTYPE nEventType,
					EVENTID nEventId,
					int nPriority);
