...
/*                                                                            */
/*============================================================================*/
// $Id: VistaDfnViewportSourceNode.cpp 21315 2011-05-16 13:47:39Z dr165799 $
...
{
	if(m_bNeedsUpdate || m_pObs->GetPropsChangeFlag()) // use the const-version here, we need the flags later
	{
