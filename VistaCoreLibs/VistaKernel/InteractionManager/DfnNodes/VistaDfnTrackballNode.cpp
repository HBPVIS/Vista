...
/*                                                                            */
/*============================================================================*/
// $Id: VistaDfnTrackballNode.cpp 21315 2011-05-16 13:47:39Z dr165799 $
...
namespace
{
	...
	void CalcRotation(float p1x, float p1y, float p2x, float p2y,
							 VistaQuaternion &result, float nScale)
	{
...
bool VistaVdfnTrackball::HandleRotate()
{
	...
	VistaQuaternion q;
	const VistaVector3D &v3Pos = m_v3BegDrag + 
		m_pOffset->GetValueConstRef();
