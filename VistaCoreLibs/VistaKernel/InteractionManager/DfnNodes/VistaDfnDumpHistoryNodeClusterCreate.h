...
/**
 * augments the cluster node name (when given) to the filename specified,
 * so log files will be "<nodenname>.<file>". It uses cluster aux for that,
 * so this is a kernel concept.
 */
