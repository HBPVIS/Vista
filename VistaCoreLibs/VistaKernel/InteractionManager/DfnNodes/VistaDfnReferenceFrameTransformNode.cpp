...
bool VistaDfnReferenceFrameTransformNode::PrepareEvaluationRun()
{
	...
	std::vector<TVdfnPort<VistaVector3D>*>::iterator itPortPos 
									= m_vecInPortsPos.begin();
	...
	std::vector<TVdfnPort<VistaQuaternion>*>::iterator itPortOri 
									= m_vecInPortsOri.begin();
	...
	std::vector<TVdfnPort<VistaTransformMatrix>*>::iterator itPortMat 
...
bool VistaDfnReferenceFrameTransformNode::DoEvalNode()
{
	...
	{
		std::vector<TVdfnPort<VistaVector3D>*>::const_iterator citPosIn 
			= m_vecInPortsPos.begin();
		std::vector<TVdfnPort<VistaVector3D>*>::iterator itPosOut 
			= m_vecOutPortsPos.begin();
		VistaVector3D v3Pos;
	...
	{
		std::vector<TVdfnPort<VistaQuaternion>*>::const_iterator citOriIn 
			= m_vecInPortsOri.begin();
		std::vector<TVdfnPort<VistaQuaternion>*>::iterator itOriOut 
			= m_vecOutPortsOri.begin();
	...
	if( m_vecInPortsMat.empty() == false )
	{
		std::vector<TVdfnPort<VistaTransformMatrix>*>::const_iterator citMatIn 
			= m_vecInPortsMat.begin();
		std::vector<TVdfnPort<VistaTransformMatrix>*>::iterator itMatOut 
			= m_vecOutPortsMat.begin();
