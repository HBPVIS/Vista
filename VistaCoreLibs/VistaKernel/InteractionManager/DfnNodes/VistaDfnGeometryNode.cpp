...
/*                                                                            */
/*============================================================================*/
// $Id: VistaDfnTrackballNode.cpp 29146 2012-02-08 15:13:47Z dr165799 $
...
VistaDfnGeometryNode::VistaDfnGeometryNode( IVistaNode* pSubtreeRoot, VistaSceneGraph* pSceneGraph,
										   bool bDeleteSubtree )
: IVdfnNode()
, m_pOffsetNode( NULL )
...
VistaDfnGeometryNode::VistaDfnGeometryNode( const VistaPropertyList& oConfig, VistaSceneGraph* pSceneGraph )
: IVdfnNode()
...
bool VistaDfnGeometryNode::DoEvalNode()
{
	...
	{
		m_pTransformNode->SetScale( m_pUniformScalePort->GetValue(),
