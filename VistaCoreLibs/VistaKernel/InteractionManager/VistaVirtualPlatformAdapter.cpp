...
/*                                                                            */
/*============================================================================*/
// $Id: VistaVirtualPlatformAdapter.cpp 21315 2011-05-16 13:47:39Z dr165799 $
...
bool VistaVirtualPlatformAdapter::SetTransform( const VistaTransformMatrix& matTransform )
{
	...
	if( fabs( v3Scale[0] - v3Scale[1] ) > 0.99999f
		|| fabs( v3Scale[0] - v3Scale[2] ) > 0.99999f )
		return false;
...
bool VistaVirtualPlatformAdapter::SetRotation( const float fX, const float fY, const float fZ, const float fW )
{
...
bool VistaVirtualPlatformAdapter::Rotate( const float fX, const float fY, const float fZ, const float fW )
{
...
bool VistaVirtualPlatformAdapter::SetTransform( const float a16fTransform[16], const bool bColumnMajor )
{
	return SetTransform( VistaTransformMatrix( a16fTransform, bColumnMajor ) );
}
bool VistaVirtualPlatformAdapter::SetTransform( const double a16dTransform[16], const bool bColumnMajor )
{
	return SetTransform( VistaTransformMatrix( a16dTransform, bColumnMajor ) );
}
bool VistaVirtualPlatformAdapter::Transform( const float a16fTransform[16], const bool bColumnMajor )
{
	return Transform( VistaTransformMatrix( a16fTransform, bColumnMajor ) );
}
bool VistaVirtualPlatformAdapter::Transform( const double a16dTransform[16], const bool bColumnMajor )
{
...
bool VistaVirtualPlatformAdapter::GetParentWorldTransform( VistaTransformMatrix& matTransform ) const
{
	return false;
}
...
bool VistaVirtualPlatformAdapter::GetWorldOrientation( float& fX, float& fY, float& fZ, float& fW ) const
{
	VistaQuaternion qResult;
...
bool VistaVirtualPlatformAdapter::GetTransform( float a16fTransform[16], const bool bColumnMajor ) const
{
...
bool VistaVirtualPlatformAdapter::GetTransform( double a16dTransform[16], const bool bColumnMajor ) const
{
	VistaTransformMatrix matTransform;
	if( GetTransform( matTransform ) == false )
		return false;
...
bool VistaVirtualPlatformAdapter::GetWorldTransform( float a16fTransform[16], const bool bColumnMajor ) const
{
	VistaTransformMatrix matTransform;
...
bool VistaVirtualPlatformAdapter::GetWorldTransform( double a16dTransform[16], const bool bColumnMajor ) const
{
	VistaTransformMatrix matTransform;
	if( GetWorldTransform( matTransform ) == false )
		return false;
...
bool VistaVirtualPlatformAdapter::GetParentWorldTransform( float a16fTransform[16], const bool bColumnMajor ) const
{
	VistaTransformMatrix matTransform;
...
bool VistaVirtualPlatformAdapter::GetParentWorldTransform( double a16dTransform[16], const bool bColumnMajor ) const
{
	VistaTransformMatrix matTransform;
	if( GetParentWorldTransform( matTransform ) == false )
		return false;
