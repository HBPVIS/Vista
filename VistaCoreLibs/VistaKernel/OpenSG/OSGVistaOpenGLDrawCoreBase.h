...
class VistaOpenGLDrawCoreBase : public MaterialDrawable
{
  ...
  protected:
    ...
    void executeSyncImpl(      VistaOpenGLDrawCoreBase *pOther,
                         const BitVector         &whichField);
...
typedef osgIF<VistaOpenGLDrawCoreBase::isNodeCore,
              CoredNodePtr<VistaOpenGLDrawCore>,
              FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC
              >::_IRet VistaOpenGLDrawCoreNodePtr;
