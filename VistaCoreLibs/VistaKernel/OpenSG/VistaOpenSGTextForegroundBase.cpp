...
/*                                                                            */
/*============================================================================*/
// $Id: VistaOpenSGTextForegroundBase.cpp 21315 2011-05-16 13:47:39Z dr165799 $
...
FieldDescription *VistaOpenSGTextForegroundBase::_desc[] = 
{
	new FieldDescription(MField<void*>::getClassType(), 
			 "texts", 
			 TextsFieldId, TextsFieldMask,
			 false,
			 (FieldAccessMethod) &VistaOpenSGTextForegroundBase::getMFTexts),
};


FieldContainerType VistaOpenSGTextForegroundBase::_type(
	"VistaOpenSGTextForeground",
	"Foreground",
	NULL,
	(PrototypeCreateF) &VistaOpenSGTextForegroundBase::createEmpty,
	 VistaOpenSGTextForeground::initMethod,
	_desc,
	sizeof(_desc));
...
VistaOpenSGTextForegroundBase::_COSGFaceHlp::_COSGFaceHlp(TextTXFFace *face, 
			 UInt32 nFaceType, UInt32 nSize,
...
void VistaOpenSGTextForegroundBase::executeSync(      FieldContainer &other,
...
VistaOpenSGTextForegroundBase::VistaOpenSGTextForegroundBase(const VistaOpenSGTextForegroundBase &source) :
...
void VistaOpenSGTextForegroundBase::copyToBin(      BinaryDataHandler &pMem,
							const BitVector         &whichField)
{
...
void VistaOpenSGTextForegroundBase::copyFromBin(      BinaryDataHandler &pMem,
							   const BitVector    &whichField)
{
...
//#if !defined(OSG_FIXED_MFIELDSYNC)
void VistaOpenSGTextForegroundBase::executeSyncImpl(      VistaOpenSGTextForegroundBase *pOther,
							   const BitVector         &whichField)
{
...
DataType FieldDataTraits<VistaOpenSGTextForegroundPtr>::_type("VistaOpenSGTextForegroundPtr", "ForegroundPtr");
