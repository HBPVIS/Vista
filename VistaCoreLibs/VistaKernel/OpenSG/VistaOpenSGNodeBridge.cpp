...
{
	//osg::subRefCP(m_ptrNode);
	m_ptrNode = node;
	//osg::addRefCP(m_pNode);
	return true;
}
...
bool VistaOpenSGNodeBridge::SetCenter
( const VistaVector3D & center, IVistaNodeData * pData )
{
...
bool VistaOpenSGNodeBridge::SetRange
( const std::vector<float> & rangeList, IVistaNodeData * pData )
{
	VistaOpenSGNodeData * pOpenSGData = static_cast<VistaOpenSGNodeData*>(pData);
	osg::DistanceLODPtr lod = osg::DistanceLODPtr::dcast(pOpenSGData->GetCore());
	if(lod == osg::NullFC)
											...
											const bool bVerbose )
{
	...
	if(flags != VistaSceneGraph::OPT_NONE)
	{
		...
		// and does not harm
			graphOperator->addGraphOp(
			new osg::VerifyGraphOp("Verify",
									false, ///< repair
									true)); ///< verbose
#endif
	...
	if(pModel != osg::NullFC)
	{
		...
		if(fScale != 1.0f)
		{
			...
			VistaTransformNode *pTransNode = NewTransformNode(NULL, pTransData, "<load-scale-trans:"+strFileName+">");
...
/*                                                                            */
/*============================================================================*/
bool VistaOpenSGNodeBridge::SetRotation(const VistaTransformMatrix& pMatrix, IVistaNodeData* pData)
{
...
bool VistaOpenSGNodeBridge::SetTransform(const VistaTransformMatrix& matrix, IVistaNodeData* pData)
{
...
bool VistaOpenSGNodeBridge::Rotate(const VistaQuaternion& pQuat, IVistaNodeData* pData)
{
	...
	//transMatrix.setRotate( osg::Quaternion( osg::Vec3f(aaa.m_v3Axis[0],aaa.m_v3Axis[1],aaa.m_v3Axis[2]), aaa.m_fAngle ) );
...
/*                                                                            */
/*============================================================================*/
bool VistaOpenSGNodeBridge::InsertChild(IVistaNodeData* pChildData, int nIndex, IVistaNodeData* pData)
{
	VistaOpenSGNodeData* pOpenSGParentData = static_cast <VistaOpenSGNodeData*>(pData);
	VistaOpenSGNodeData* pOpenSGChildData  = static_cast <VistaOpenSGNodeData*>(pChildData);
	beginEditCP(pOpenSGParentData->GetNode(), osg::Node::ChildrenFieldMask);
...
{
	VistaOpenSGNodeData* pOpenSGParentData = static_cast <VistaOpenSGNodeData*>(pData);
	if( pOpenSGParentData->GetNode() == osg::NullFC || pOpenSGParentData->GetNode()->getNChildren() < 1 )
		return false;
...
bool VistaOpenSGNodeBridge::SetLightColor(VISTA_LIGHTTYPE t,
					   float r,
					   float g,
					   float b,
	...
	case VISTA_SPOT_LIGHT:
		{
			...
			beginEditCP( pLight, osg::Light::AmbientFieldMask |
								 osg::Light::DiffuseFieldMask |
								 osg::Light::SpecularFieldMask);

			pLight->setAmbient(osg::Real32(r),
				osg::Real32(g),
				osg::Real32(b),
				OSG_LIGHTALPHA_DEFAULT);
			pLight->setDiffuse(osg::Real32(1.0f),
				osg::Real32(1.0f),
				osg::Real32(1.0f),
				OSG_LIGHTALPHA_DEFAULT);
			pLight->setSpecular(osg::Real32(1.0f),
				osg::Real32(1.0f),
				osg::Real32(1.0f),
				OSG_LIGHTALPHA_DEFAULT);
...
bool VistaOpenSGNodeBridge::SetLightAmbientColor(VISTA_LIGHTTYPE t,
	...
	case VISTA_SPOT_LIGHT:
		{
			...
			if(pLight == osg::NullFC)
				return false;
			pOpenSGData->m_cAmbient = osg::Color4f(osg::Real32(r),
												   osg::Real32(g),
												   osg::Real32(b),
												   OSG_LIGHTALPHA_DEFAULT);
...
bool VistaOpenSGNodeBridge::SetLightDiffuseColor(VISTA_LIGHTTYPE t,
												  float r, float g, float b,
												  IVistaNodeData *pData)
{
	VistaOpenSGLightNodeData* pOpenSGData =
	...
	case VISTA_SPOT_LIGHT:
		{
			...
			if(pLight == osg::NullFC)
				return false;
			pOpenSGData->m_cDiffuse = osg::Color4f(osg::Real32(r),
				osg::Real32(g),
				osg::Real32(b),
				OSG_LIGHTALPHA_DEFAULT);
...
bool VistaOpenSGNodeBridge::SetLightSpecularColor(VISTA_LIGHTTYPE t,
						   float r, float g, float b,
						   IVistaNodeData *pData)
{
	VistaOpenSGLightNodeData* pOpenSGData = static_cast <VistaOpenSGLightNodeData*>(pData);
	...
	case VISTA_SPOT_LIGHT:
		{
			...
			if(pLight == osg::NullFC)
				return false;
			pOpenSGData->m_cSpecular = osg::Color4f(osg::Real32(r),
													osg::Real32(g),
													osg::Real32(b),
													OSG_LIGHTALPHA_DEFAULT);
...
bool VistaOpenSGNodeBridge::SetLightAttenuation(VISTA_LIGHTTYPE t,
						 const VistaVector3D&att,
						 IVistaNodeData* pData)
{
	VistaOpenSGLightNodeData* pOpenSGData = static_cast <VistaOpenSGLightNodeData*>(pData);
	switch(t)
...
bool VistaOpenSGNodeBridge::SetLightPosition(VISTA_LIGHTTYPE t,
						  const VistaVector3D &pos,
						  IVistaNodeData *pData)
{
	switch(t)
	{
	...
	case VISTA_SPOT_LIGHT:
		{
			...
			{
				beginEditCP( pLight,
					osg::PointLight::PositionFieldMask);
				pLight->setPosition(osg::Real32(pos[0]),
									osg::Real32(pos[1]),
									osg::Real32(pos[2]));
...
bool VistaOpenSGNodeBridge::SetLightDirection(VISTA_LIGHTTYPE t,
											   const VistaVector3D &dir,
											   IVistaNodeData *pData)
{
	VistaOpenSGLightNodeData* pOpenSGData = static_cast <VistaOpenSGLightNodeData*>(pData);
	if(!pOpenSGData)
	...
	case VISTA_DIRECTIONAL_LIGHT:
		{
			osg::DirectionalLightPtr pLight
				= osg::DirectionalLightPtr::dcast(pOpenSGData->GetLightCore());
											  ...
											  const IVistaNodeData *pData) const
{
	...
	case VISTA_SPOT_LIGHT:
		{
			osg::PointLightPtr pLight
				= osg::PointLightPtr::dcast(pOpenSGData->GetLightCore());
