...
VistaOpenSGTextForeground::~VistaOpenSGTextForeground(void)
{
	for(MField<void*>::const_iterator cit = m_vFaceLookup.begin(); cit != m_vFaceLookup.end(); ++cit)
	{
...
VistaOpenSGTextForegroundBase::_COSGFaceHlp *VistaOpenSGTextForeground::initTextFace(UInt32 nFaceType, UInt32 size)
{
	TextTXFParam param;
