...
/*                                                                            */
/*============================================================================*/
// $Id: VistaZeroMQClusterDataSync.cpp 29861 2012-04-10 15:04:51Z dr165799 $
...
: VistaClusterBytebufferLeaderDataSyncBase( bVerbose )
{
	...
	{	
		...
		m_pSocket->setsockopt( ZMQ_RATE, &S_nMaxBandwidth, sizeof(VistaType::uint64) );	
...
VistaZeroMQClusterLeaderDataSync::VistaZeroMQClusterLeaderDataSync( const std::string& sZeroMQAddress,
																   const bool bVerbose )
: VistaClusterBytebufferLeaderDataSyncBase( bVerbose )
{
	VistaZeroMQCommon::RegisterZeroMQUser();
...
bool VistaZeroMQClusterLeaderDataSync::DoSendMessage()
{
	...
	if( m_pExtBuffer )
		memcpy( (VistaType::byte*)oZmqMsg.data() + m_oMessage.GetBufferSize(), m_pExtBuffer, m_nExtBufferSize );
...
bool VistaZeroMQClusterLeaderDataSync::WaitForConnection( const std::vector<VistaConnectionIP*>& vecConnections )
{
...
VistaZeroMQClusterFollowerDataSync::VistaZeroMQClusterFollowerDataSync( const std::string& sHostname, 
																	const int nServerPort,
																	const bool bSwap,
																	const bool bVerbose )
...
VistaZeroMQClusterFollowerDataSync::VistaZeroMQClusterFollowerDataSync( const std::string& sZeroMQAddress,
																	 const bool bSwap,
																	 const bool bVerbose )
: VistaClusterBytebufferFollowerDataSyncBase( bSwap, bVerbose )
{
...
bool VistaZeroMQClusterFollowerDataSync::DoReceiveMessage()
{
	...
	m_oMessage.SetBuffer( static_cast<VistaType::byte*>( m_pZmqMessage->data() ) + sizeof(VistaType::sint32), nSize  );
