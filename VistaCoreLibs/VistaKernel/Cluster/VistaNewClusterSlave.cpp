...
bool VistaNewClusterSlave::WaitForClusterMaster( int nPort )
{
	try
	{
		...
		m_pConnection->SetByteorderSwapFlag( false );
		...
		m_pConnection->SetByteorderSwapFlag( m_bDoByteSwap );
		...
		m_pSyncConnection->SetByteorderSwapFlag( m_bDoByteSwap );
...
VistaConnectionIP* VistaNewClusterSlave::CreateConnectionToMaster()
{
	...
	{	
		...
		pConnection->SetByteorderSwapFlag( m_bDoByteSwap );
	}
	catch( VistaExceptionBase& e )
	{
