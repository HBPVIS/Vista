...
/*                                                                            */
/*============================================================================*/
// $Id: VistaNewClusterMaster.cpp 24616 2012-01-09 16:33:39Z dr165799 $
...
void VistaMasterSlave::FillPortListFromIni( const std::string& sEntry, 
												FreePortList& vecPorts )
{
	...
	{
		vstr::warnp() << "Cannot interprete port list string ["
						<< sEntry << "]" << std::endl;
		return;
	}
...
std::string VistaMasterSlave::GetSwapSyncModeName( const int m_nSwapSyncMethod )
{
	...
	{
		case SWAPSYNC_TCP:			return "TCP/IP";
		case SWAPSYNC_BROADCAST:	return "Broadcast";
		case SWAPSYNC_INTERPROC:	return "InterProc";
		case SWAPSYNC_GSYNCGROUP:	return "nVidia GSYNC";
		case SWAPSYNC_DUMMY:		return "Dummy";
		case SWAPSYNC_NONE:			return "None";
		case SWAPSYNC_DEFAULTBARRIER:	return "Default Barrier";
	}
	return "Unknown";
}
...
std::string VistaMasterSlave::GetBarrierModeName( const int m_nBarrierMethod )
{
	...
	{
		case BARRIER_TCP:			return "TCP/IP";
		case BARRIER_DUMMY:			return "Dummy";
		case BARRIER_INTERPROC:		return "InterProc";
		case BARRIER_BROADCAST:		return "Broadcast";
	}
	return "Unknown";
}
