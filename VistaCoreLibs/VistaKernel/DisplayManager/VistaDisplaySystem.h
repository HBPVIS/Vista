...
/*                                                                            */
/*============================================================================*/
// $Id: VistaDisplaySystem.h 20730 2011-03-30 15:56:24Z dr165799 $

#if !defined(_VISTADISPLAYSYSTEM_H)
...
public:
	...
	public:
		...
		void GetEyeOffsets(VistaVector3D &v3LeftOffset,
						   VistaVector3D &v3RightOffset) const;
		void SetEyeOffsets(const VistaVector3D &v3LeftOffset,
	...
	private:
		VistaDisplaySystemProperties(VistaDisplaySystem *pParent,
...
protected:
	...
	VistaDisplaySystem(VistaDisplayManager *pDisplayManager,
...
#endif // !defined(_VISTADISPLAYSYSTEM_H)
