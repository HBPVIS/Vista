...
/*                                                                            */
/*============================================================================*/
// $Id: Vista2DDrawingObjects.cpp 21315 2011-05-16 13:47:39Z dr165799 $
...
Vista2DDrawingObject::Vista2DDrawingObject(float fXPos, float fYPos, unsigned char nRed, unsigned char nGreen, unsigned char nBlue)
{
	m_fXPos = fXPos;
	m_fYPos = fYPos;
	m_nRed = nRed;
...
{	
	if(fXPos>= 0.0 && fXPos <= 1.0 && fYPos >= 0.0 && fYPos <=1.0)
	{
		m_fXPos = fXPos;
		m_fYPos = fYPos;
		return true;
...
// ============================================================================
// ============================================================================
bool Vista2DDrawingObject::GetColor(unsigned char& nRed, unsigned char& nGreen, unsigned char& nBlue)
{
	nRed = m_nRed;
	nGreen = m_nGreen;
	nBlue = m_nBlue;
...
// ============================================================================
// ============================================================================
bool Vista2DText::Init(const std::string &strText, float nPosX, float nPosY, 
...
{
	if(m_pDispBridge->DoLoadBitmap(strNewFName, &m_pBitmapData, m_nWidth, m_nHeight, m_bAlphaChannel))
	{
...
/*
Vista2DLine::Vista2DLine(float fXPos1, float fYPos1, float fXPos2, float fYPos2, unsigned char nRed, unsigned char nGreen, unsigned char nBlue)
						:  Vista2DDrawingObject(fXPos1, fYPos1, nRed, nGreen, nBlue)
{
	m_fXPos2 = fXPos2;
	m_fYPos2 = fYPos2;
}
