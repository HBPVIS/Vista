...
public:
	...
	Vista2DDrawingObject();
	Vista2DDrawingObject(float fPosX, float fPosY,
						  unsigned char nRed,
...
public:
	 ...
	 * @return bool true/false
	 */
	virtual bool Init(const std::string &strText, float fPosX, float fPosY,
			  unsigned char nRed=255, unsigned char nGreen=255, unsigned char nBlue=0,
			  unsigned int size=20, Vista2DTextFontFamily family=SANS);
...
public:
	 ...
	 * @return bool true/false
	 */
	virtual bool Init(const std::string &strFName,
...
public:
	 ...
	 * @return bool true/false
	 */
	virtual bool Init( float fPosX, float fPosY, float fWidth, float fHeight, unsigned char nRed=255, unsigned char nGreen=255, unsigned char nBlue=0);
...
public:
	Vista2DLine();
	//Vista2DLine(float nX1, float nY1, float nX2, float nY2, unsigned char nRed, unsigned char nGreen, unsigned char nBlue);
	virtual ~Vista2DLine();
	 ...
	 * @return bool true/false
	 */
	virtual bool Init(float fPosX1, float fPosY1, float fPosX2, float fPosY2, unsigned char nRed=255, unsigned char nGreen=255, unsigned char nBlue=0);
