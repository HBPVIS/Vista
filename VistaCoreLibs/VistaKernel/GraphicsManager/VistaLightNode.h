...
protected:
	VistaLightNode();
	VistaLightNode(	VistaGroupNode*			pParent,
...
public:
protected:
	VistaAmbientLight(	VistaGroupNode*			pParent,
						IVistaNodeBridge*			pBridge,
						IVistaNodeData*				pData,
						const std::string	&strName);
...
protected:
	VistaDirectionalLight(	VistaGroupNode*			pParent,
						IVistaNodeBridge*			pBridge,
						IVistaNodeData*				pData,
						const std::string	&strName);
...
protected:
	VistaPointLight(	VistaGroupNode*			pParent,
						IVistaNodeBridge*			pBridge,
						IVistaNodeData*				pData,
						const std::string &strName);
};
...
public:
	...
	*/
	...
	enum eLightDistribution
	{
		SPOT_DIST_UNIFORM = 0,
		SPOT_DIST_AVERAGE = 64,
		SPOT_DIST_DENSE   = 128
	};
...
protected:
	VistaSpotLight(	VistaGroupNode*			pParent,
						IVistaNodeBridge*			pBridge,
						IVistaNodeData*				pData,
						const std::string &strName);
