...
/*                                                                            */
/*============================================================================*/
// $Id: VistaLightNode.cpp 21315 2011-05-16 13:47:39Z dr165799 $
...
VistaLightNode::VistaLightNode(VistaGroupNode*				pParent, 
...
VistaAmbientLight::VistaAmbientLight(VistaGroupNode*				pParent, 
								 IVistaNodeBridge*				pBridge,
								 IVistaNodeData*				pData,
								 const std::string	&strName)
...
VistaDirectionalLight::VistaDirectionalLight(VistaGroupNode*				pParent, 
								 IVistaNodeBridge*				pBridge,
								 IVistaNodeData*				pData,
								 const std::string	&strName)
: VistaLightNode(pParent, pBridge, pData, strName)
...
VistaPointLight::VistaPointLight(VistaGroupNode*				pParent, 
								 IVistaNodeBridge*				pBridge,
								 IVistaNodeData*				pData,
								 const std::string	&strName)
: VistaLightNode(pParent, pBridge, pData, strName)
...
VistaSpotLight::VistaSpotLight(VistaGroupNode*				pParent, 
								 IVistaNodeBridge*				pBridge,
								 IVistaNodeData*				pData,
								 const std::string	&strName)
: VistaLightNode(pParent, pBridge, pData, strName)
