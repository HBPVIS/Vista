...
//      bool IsIndexed() const;
	...
	//! This function returns a coordinate (DEPRECATED!)
	/** All different coordinates are stored in a list (they need not but should be
	...
	//! Alter the value of a coordinate (DEPRECATED!)
	/** This function alters a single coordinate.
	 *  \param idx The coordinate in question.
	 *  \param coord The new values.
	 *  \return Success?
	...
	//! Change the texsture coordinate with index idx (DEPRECATED!)
	...
	//! Return the normal with given index (DEPRECATED!)
	...
	//! Change a normal to the given values (DEPRECATED!).
