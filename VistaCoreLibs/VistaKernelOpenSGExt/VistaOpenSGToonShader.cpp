...
const std::string VistaOpenSGToonShader::m_sVertexShader = \
...
const std::string VistaOpenSGToonShader::m_sFragmentShader = \
...
bool VistaOpenSGToonShader::ReloadFromFile()
{
...
bool VistaOpenSGToonShader::ReloadFromFile( const std::string& sVertexShaderFile,
						const std::string& sFragmentShaderFile )
{
	m_sVertexShaderFile = sVertexShaderFile;
	m_sFragmentShaderFile = sFragmentShaderFile;
...
bool VistaOpenSGToonShader::ApplyToGeometry( VistaGeometry *pGeometry )
{
...
bool VistaOpenSGToonShader::RemoveFromGeometry( VistaGeometry *pGeometry )
{
	return m_pShader->RemoveFromGeometry( pGeometry );
}

bool VistaOpenSGToonShader::ApplyToAllGeometries( IVistaNode* pNode )
{
...
bool VistaOpenSGToonShader::RemoveFromAllGeometries( IVistaNode* pNode )
{
	//std::queue<IVistaNode*> queNodes;
	//queNodes.push( pNode );
	//IVistaNode* pCurrentNode;
...
bool VistaOpenSGToonShader::GetIsEnabled() const
{
	return m_bEnabled;
}
bool VistaOpenSGToonShader::SetIsEnabled( const bool bSet )
{
	// mean MEAN hack!
	if( bSet == m_bEnabled )
		return false;
