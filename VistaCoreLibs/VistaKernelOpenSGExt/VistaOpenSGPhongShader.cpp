...
"   \n"
"	vec3 v3HalfVec = normalize( v3ViewVec + v3LightDir );\n"
"   \n"
"	float fNdotL = dot( v3Normal, v3LightDir );\n"
"	if( fNdotL > 0.0 )\n"
"	{\n"
"		\n"
"		//Diffuse Term\n"
...
"       {\n"
"         float fNdotHV = max( dot( v3Normal, v3HalfVec ), 0.0 );\n"
...
"   vec3 v3ViewVec = -normalize( v3WorldPos );\n"
...
"\n"
"	if( OSGLight0Active )\n"
"		ProcessLight( 0, v3Normal, v3ViewVec, v4Color );\n"
"	if( OSGLight1Active )\n"
"		ProcessLight( 1, v3Normal, v3ViewVec, v4Color );\n"
"	if( OSGLight2Active )\n"
"		ProcessLight( 2, v3Normal, v3ViewVec, v4Color );\n"
"	if( OSGLight3Active )\n"
"		ProcessLight( 3, v3Normal, v3ViewVec, v4Color );\n"
"	if( OSGLight4Active )\n"
"		ProcessLight( 4, v3Normal, v3ViewVec, v4Color );\n"
"	if( OSGLight5Active )\n"
"		ProcessLight( 5, v3Normal, v3ViewVec, v4Color );\n"
"	if( OSGLight6Active )\n"
"		ProcessLight( 6, v3Normal, v3ViewVec, v4Color );\n"
"	if( OSGLight7Active )\n"
"		ProcessLight( 7, v3Normal, v3ViewVec, v4Color );\n"
"\n"
