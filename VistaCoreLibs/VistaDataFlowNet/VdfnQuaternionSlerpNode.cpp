...
{
   // define Inports
   RegisterInPortPrototype( S_sFirstQuaternionInPortName,  new TVdfnPortTypeCompare< TVdfnPort< VistaQuaternion > > );
   RegisterInPortPrototype( S_sSecondQuaternionInPortName, new TVdfnPortTypeCompare< TVdfnPort< VistaQuaternion > > );
...
bool VdfnQuaternionSlerpNode::PrepareEvaluationRun()
{
   ...
   m_pInFirstQuaternion  = dynamic_cast< TVdfnPort< VistaQuaternion > *>( GetInPort( S_sFirstQuaternionInPortName ) );
   m_pInSecondQuaternion = dynamic_cast< TVdfnPort< VistaQuaternion > *>( GetInPort( S_sSecondQuaternionInPortName ) );
