...
/*                                                                            */
/*============================================================================*/
// $Id: VdfnAggregateNode.h 20730 2011-03-30 15:56:24Z dr165799 $
...
public:
	 ...
	 * @todo why check on m_strInValue.empty()? m_pGetFunction == NULL should be enough
	 */
...
protected:
	virtual bool DoEvalNode()
	{
		...
		// resize to a proper width (intelligent implementations of vector will not lead
		// to memory thrashing (hopefully))
		...
		for(unsigned int n=0; n < nNewMeasureCount; ++n)
		{
			...
			const VistaSensorMeasure *pMeasure = pData->m_oHistory.GetPast(n);
