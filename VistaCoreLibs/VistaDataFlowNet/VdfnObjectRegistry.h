...
/*                                                                            */
/*============================================================================*/
// $Id: VdfnObjectRegistry.h 20730 2011-03-30 15:56:24Z dr165799 $
 ...
 */
class VISTADFNAPI VdfnObjectRegistry
{
public:
	VdfnObjectRegistry();
	 ...
	 * The method checks whether strName was already registered beforhand
...
protected:
private:
	typedef std::pair<IVistaNameable*, IVistaTransformable*> OBJ;
