...
TEST( VistaTestingCompare, VistaColor )
{
	...
	ASSERT_TRUE( VistaTesting::Compare( VistaColor( 0.1f, 0.2f, 0.3f, 0.4f ), VistaColor( 0.1f, 0.2f, 0.3f, 0.4f ) ) );
	ASSERT_FALSE( VistaTesting::Compare( VistaColor( -1, 1, -1 ), VistaColor( -1, 1, 1 ) ) );
	ASSERT_FALSE( VistaTesting::Compare( VistaColor( 0.0f, 1.0f, 0.0f ), VistaColor( 0.0f, 1.00001f, 0.0f ) ) );
	ASSERT_TRUE( VistaTesting::Compare( VistaColor( 0.0f, 1.0f, 0.0f ), VistaColor( 0.0f, 1.00001f, 0.0f ), 1e-4 ) );
}

TEST( VistaTestingCompare, VistaVector3D )
{
	ASSERT_TRUE( VistaTesting::Compare( VistaVector3D( 0, 1, 0 ), VistaVector3D( 0, 1, 0 ) ) );
	ASSERT_TRUE( VistaTesting::Compare( VistaVector3D( 0.1f, 0.2f, 0.3f, 0.4f ), VistaVector3D( 0.1f, 0.2f, 0.3f, 0.4f ) ) );
...
TEST( VistaTestingCompare, VistaQuaternion )
{
	...
	ASSERT_TRUE( VistaTesting::Compare( VistaQuaternion( 0.1f, 0.2f, 0.3f, 0.4f ), VistaQuaternion( 0.1f, 0.2f, 0.3f, 0.4f ) ) );
	ASSERT_FALSE( VistaTesting::Compare( VistaQuaternion( 0, 1, 0, 0 ), VistaQuaternion( 0, 1.00001f, 0, 0 ) ) );
	ASSERT_TRUE( VistaTesting::Compare( VistaQuaternion( 0, 1, 0, 0 ), VistaQuaternion( 0, 1.00001f, 0, 0 ), 1e-4 ) );
	ASSERT_TRUE( VistaTesting::Compare( VistaQuaternion( 0, 0, 0, 1 ), VistaQuaternion( 0, 0, 0, -1 ) ) );
	ASSERT_FALSE( VistaTesting::Compare( VistaQuaternion( 0, 0.1f, 0, 1 ), VistaQuaternion( 0, 0.1f, 0, -1 ) ) );
	ASSERT_FALSE( VistaTesting::Compare( VistaQuaternion( 0, 0.707f, 0, 0.707f ), VistaQuaternion( 0, 0.707f, 0, -0.707f ) ) );
}
...
TEST( VistaTestingCompare, pair )
{
	...
	ASSERT_FALSE( VistaTesting::Compare( std::make_pair( 1.00001f, "test" ), std::make_pair( 1.0f, "test" ) ) );
	std::vector< long double > vecLeft, vecRight;
	vecLeft.push_back( 10000.1 );
	vecRight.push_back( 10000.0 );
	ASSERT_TRUE( VistaTesting::Compare( std::make_pair( 1.00001f, vecLeft ), std::make_pair( 1.0f, vecRight ), 1e-4 ) );	
}
...
TEST( VistaTestingCompare, Property )
{
	...
	ASSERT_FALSE( VistaTesting::Compare( oLeft, oRight ) );
	oRight = VistaProperty( "test", "1, 2, 3.00001", VistaProperty::PROPT_LIST, VistaProperty::PROPT_DOUBLE );
	ASSERT_FALSE( VistaTesting::Compare( oLeft, oRight ) );
	ASSERT_TRUE( VistaTesting::Compare( oLeft, oRight, 1e-4 ) );
