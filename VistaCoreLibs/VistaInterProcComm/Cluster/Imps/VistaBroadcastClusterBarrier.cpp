...
VistaBroadcastClusterLeaderBarrier::VistaBroadcastClusterLeaderBarrier( 
												const std::string& sBroadcastIP,
												const std::vector<int>& vecBroadcastPorts,
												const bool bVerbose )
: VistaClusterLeaderBarrierIPBase( bVerbose )
{
...
VistaBroadcastClusterLeaderBarrier::VistaBroadcastClusterLeaderBarrier(
												const std::vector<VistaUDPSocket*>& vecSockets,
...
bool VistaBroadcastClusterLeaderBarrier::AddBroadcast( const std::string& sBroadcastIP,
													  const int nBroadcastPort )
{
...
bool VistaBroadcastClusterLeaderBarrier::AddBroadcast( VistaUDPSocket* pBroadcastSocket,
														const bool bManageDeletion )
{
...
bool VistaBroadcastClusterLeaderBarrier::BarrierWait( int iTimeOut )
{
	...
	if( VistaBroadcastClusterLeaderBarrier::WaitForAllFollowers( iTimeOut ) == false )
		return false;
...
, m_bManageSocket( true )
{
	...
	{
		vstr::errp() << "[" << GetBarrierType() << "]: "
					<< "Provided address [" << sBroadcastIP << ":" << nBroadcastPort
					<< "] is invalid" << std::endl;
		ProcessError();
	}
