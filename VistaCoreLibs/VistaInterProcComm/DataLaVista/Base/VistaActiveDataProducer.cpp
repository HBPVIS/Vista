...
/*                                                                            */
/*============================================================================*/
// $Id: VistaActiveDataProducer.cpp 21315 2011-05-16 13:47:39Z dr165799 $
...
bool DLVistaActiveDataProducer::AcceptDataPacket(IDLVistaDataPacket *pPacket, IDLVistaPipeComponent *pComp, bool bBlock)
{
	return m_pRealProducer->AcceptDataPacket(pPacket, this, bBlock);
}

bool DLVistaActiveDataProducer::RecycleDataPacket(IDLVistaDataPacket *pPacket, IDLVistaPipeComponent *pComp, bool bBlock)
{
