...
/*                                                                            */
/*============================================================================*/
// $Id: VistaRamQueuePipe.cpp 21315 2011-05-16 13:47:39Z dr165799 $
...
:	m_pquInQueue(new deque<IDLVistaDataPacket *>),
	...
	m_pRecycleEvent(new VistaThreadEvent(true)),
	m_pQueueNotEmptyEvent(new VistaThreadEvent(true)),
	m_bCanRecycle(false),
...
//
//			
////			printf("DLVistaRamQueuePipe::ReturnPacket(): Recylce-request pending on empty queue... thread blocking.\n");
////			if((*m_pRecycleEvent).WaitForEvent(5)==1) // block, but only wait for a short burst!
////			{
////				printf("DLVistaRamQueuePipe::ReturnPacket(): Got signal... there must be some packets in the recycle-queue\n");
////			}
////			else
////			{
...
////			{
////				printf("DLVistaRamQueuePipe::ReturnPacket(): Got mutex to queue.\n");
////			}
...
//			pPacket = (*m_pquRecycleQueue).front();
//			(*m_pquRecycleQueue).pop_front();
////			printf("DLVistaRamQueuePipe::ReturnPacket() -- Returning packet %X to active component. -- recycle queue-size = %d\n", pPacket, (*m_pquRecycleQueue).size());
//		}
//		else
//		{
...
bool DLVistaRamQueuePipe::RecycleDataPacket(IDLVistaDataPacket *pPacket, IDLVistaPipeComponent *pComp, bool bBlock)
{
...
bool DLVistaRamQueuePipe::AcceptDataPacket(IDLVistaDataPacket *pPacket, IDLVistaPipeComponent *pComp, bool bBlock)
{
	bool bRet = false;
	if(GrabMutex(m_pMutexIn, bBlock))
	{
