...
/*                                                                            */
/*============================================================================*/
// $Id: VistaByteBufferPacket.cpp 22128 2011-07-01 11:30:05Z dr165799 $
...
int DLVistaByteBufferPacket::DeSerialize(IVistaDeSerializer &rDeSerializer){
	...
	{
		printf("\n\n[DLVistaByteBufferPacket::DeSerialize] ERROR: Wrong signature encountered! Packet could not be deser'ed\n\n");
		return -1;
	}
}
