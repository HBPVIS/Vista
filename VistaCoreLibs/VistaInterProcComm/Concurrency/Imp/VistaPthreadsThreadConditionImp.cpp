...
/*                                                                            */
/*============================================================================*/
// $Id: VistaPthreadsThreadConditionImp.cpp 21315 2011-05-16 13:47:39Z dr165799 $
...
{
	return pthread_cond_wait(&m_Condition, (static_cast<VistaPthreadsMutexImp*>(pMutexImp)->GetPthreadMutex()));
}
