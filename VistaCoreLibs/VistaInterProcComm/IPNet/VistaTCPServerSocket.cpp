...
/*                                                                            */
/*============================================================================*/
// $Id: VistaTCPServerSocket.cpp 21315 2011-05-16 13:47:39Z dr165799 $
...
#else
	if((iNewSockAddr=accept(SOCKET(GetSocketID()), (sockaddr*)remote.GetINAddress(), (socklen_t*)&iNewSockAddrLength))<0)
#endif
	{
		// error!!
