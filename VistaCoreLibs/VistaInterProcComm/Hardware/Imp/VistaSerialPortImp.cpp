...
/*                                                                            */
/*============================================================================*/
// $Id: VistaSerialPortImp.cpp 21315 2011-05-16 13:47:39Z dr165799 $
...
VistaSerialPortStateDesc::VistaPortIndex     VistaSerialPortImp::HasPortName(const string &sPortName) const
{
...
bool VistaSerialPortImp::SetPortByIndex(VistaSerialPortStateDesc::VistaPortIndex iIndex)
{
	...
	case VistaSerialPortStateDesc::CSP_USER:
		{
			m_ePortIndex = (VistaSerialPortStateDesc::VistaPortIndex)iIndex; // user is different, but not N/A! so simply set this without changing the name
			break;
		}
	default:
		{
