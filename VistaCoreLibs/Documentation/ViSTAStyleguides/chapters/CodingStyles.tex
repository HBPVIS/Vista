...
// class variables go here, too - note that they of course mustn't go into the anonymous namespace!
...
Types are nice, but usually the are associated with attributes, e.g., static or singed/unsigned qualifiers.
...
\end{verbatim}
\item Provide \emph{special public constructors} if you can not initialize an instance properly with a default constructor.
\begin{verbatim}
class C
{
public:
