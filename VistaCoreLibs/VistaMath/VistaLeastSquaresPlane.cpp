...
/*                                                                            */
/*============================================================================*/
// $Id: VistaLeastSquaresPlane.cpp 21315 2011-05-16 13:47:39Z dr165799 $
												 ...
												 VistaVector3D& v3PlaneNormal)
{
	...
	*/
	...
	for(i=0; i<vecPoints.size(); ++i)
	{
		...
		//compute entries
		m3SymMatrix[0][0] += v3Offset[0] * v3Offset[0];
		m3SymMatrix[0][1] += v3Offset[0] * v3Offset[1];
		m3SymMatrix[0][2] += v3Offset[0] * v3Offset[2];
		m3SymMatrix[1][1] += v3Offset[1] * v3Offset[1];
		m3SymMatrix[1][2] += v3Offset[1] * v3Offset[2];
		m3SymMatrix[2][2] += v3Offset[2] * v3Offset[2];
	}
...
/*                                                                            */
/*============================================================================*/
void VistaLeastSquaresPlane::ComputeLeastSquaresPlane(  const std::vector<double*>& vecPoints,
														 ...
														 double nPlaneNormal[3])
{
	...
	*/
	...
	for(i=0; i<vecPoints.size(); ++i)
	{
		//compute offset vector from median
		for(j=0;j<3;++j)
			fOffset[j] = (float)( vecPoints[i][j] - nPlaneCenter[j] );
		//compute entries
...
/*                                                                            */
/*============================================================================*/
void VistaLeastSquaresPlane::ComputeLeastSquaresPlane(  const std::vector<float*>& vecPoints,
														 ...
														 float fPlaneNormal[3])
{
	...
	*/
	...
	for(i=0; i<vecPoints.size(); ++i)
	{
		//compute offset vector from median
		for(j=0;j<3;++j)
			fOffset[j] = vecPoints[i][j] - fPlaneCenter[j];
		//compute entries
		m3SymMatrix[0][0] += fOffset[0] * fOffset[0];
		m3SymMatrix[0][1] += fOffset[0] * fOffset[1];
		m3SymMatrix[0][2] += fOffset[0] * fOffset[2];
...
/*                                                                            */
/*============================================================================*/
void VistaLeastSquaresPlane::ComputePlaneNormal( VistaSquareMatrix<double,3>& rMatrix, VistaVector3D& v3PlaneNormal)
{
	/*
