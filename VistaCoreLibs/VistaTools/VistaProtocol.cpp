	...
	if(m_sFileName != "")
	{
		...
		else
		{
			...
			/*Output of header for protocol*/
				...
				Protocol << "Number of Processors  : " << VistaEnvironment::GetNumberOfProcessors() << std::endl;
				...
				Protocol << "Compile flag SYSTEM : " << VistaEnvironment::GetCompileFlagSYSTEM()  << std::endl << std::endl;
				Protocol << "========================================================\n";
			};
