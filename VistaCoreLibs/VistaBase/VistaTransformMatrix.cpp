									...
									VistaQuaternion& qScaleRotation ) const
{
	...
	v3Translation[0] = (float)( parts.t[Vista::X] * mul );
	v3Translation[1] = (float)( parts.t[Vista::Y] * mul );
	v3Translation[2] = (float)( parts.t[Vista::Z] * mul );
	...
	mul *= parts.f;
	v3Scale[0] = (float)( parts.k.x * mul );
	v3Scale[1] = (float)( parts.k.y * mul );
	v3Scale[2] = (float)( parts.k.z * mul );
