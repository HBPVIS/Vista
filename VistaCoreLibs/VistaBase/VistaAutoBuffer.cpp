...
VistaAutoBuffer::~VistaAutoBuffer()
{
	if((*m_cnt).DecAndTestNull())
	{
		delete m_cnt;
		delete m_vecBuffer;
//		std::cout << "VistaAutoBuffer::~VistaAutoBuffer(" << this << ") -- delete" << std::endl;
	}
}
...
VistaAutoWriteBuffer::iterator VistaAutoWriteBuffer::insert( iterator position, const value_type &v )
{
