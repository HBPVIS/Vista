...
namespace
{
	...
	sDevLookup SDevCaps[] =
	{
		sDevLookup( 0x046d, 0xc626, "3DCONNEXION_SPACENAVIGATOR" ),
	...
	m_pMeasure(new VistaHIDCommonShare::sHIDMeasure)
{
	...
	pSen->SetMeasureTranscode( GetFactory()->GetTranscoderFactoryForSensor("HID_RAW")->CreateTranscoder() );
	pSen->SetTypeHint( GetFactory()->GetTypeFor( "HID_RAW" ) );
	AddDeviceSensor( pSen );

	//m_pSensorMappingAsp->RegisterType("GRIFFIN_POWERMATE",
	//								  sizeof(_sHIDMeasure),
	//								  100, GetFactory()->GetTranscoderFactoryForSensor("GRIFFIN_POWERMATE"));

	//m_pSensorMappingAsp->RegisterType("3DCONNEXION_SPACENAVIGATOR",
	//									sizeof(_sHIDMeasure),
	//									100, GetFactory()->GetTranscoderFactoryForSensor("3DCONNEXION_SPACENAVIGATOR"));

	//m_pSensorMappingAsp->RegisterType("3DCONNEXION_SPACENAVIGATOR_CMD",
	//								  sizeof(_sHIDMeasure),
	//								  100, GetFactory()->GetTranscoderFactoryForSensor("3DCONNEXION_SPACENAVIGATOR_CMD"));

	//m_pSensorMappingAsp->RegisterType("LOGITECH_RUMBLEPAD2",
	//								  sizeof(_sHIDMeasure),
	//								  100, GetFactory()->GetTranscoderFactoryForSensor("LOGITECH_RUMBLEPAD2"));
	...
	//								  sizeof(_sHIDMeasure),
	//								  100, GetFactory()->GetTranscoderFactoryForSensor("HID_RAW"));
...
*/
		...
		VistaHIDCommonShare::sHIDMeasure *pMeasure = (VistaHIDCommonShare::sHIDMeasure*)&(*pM).m_vecMeasures[0];
