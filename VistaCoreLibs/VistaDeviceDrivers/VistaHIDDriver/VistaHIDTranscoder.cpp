										  ...
										  double &dScalar ) const
{
	...
	VistaHIDCommonShare::sHIDMeasure *m = (VistaHIDCommonShare::sHIDMeasure*)&(*pMeasure).m_vecMeasures[0];
...
public:
	...
	static void CreateCreators(CRMAP &mp)
	{
		...
		mp["3DCONNEXION_SPACENAVIGATOR_CMD"]  = new TCreateTranscoder<VistaHIDDriverSpaceNavigatorCmdTranscode>;
