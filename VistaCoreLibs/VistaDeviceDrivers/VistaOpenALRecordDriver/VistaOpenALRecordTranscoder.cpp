...
namespace
{
	...
	public:
		  VistaOpenALRecordAudioTranscoder()
		{
		  ...
		  static std::string GetTypeString() { return "VistaOpenALRecordAudioTranscoder"; }
	};
	...
	public:
		  VistaOpenALRecordTypeTranscoder()
		{
		  ...
		  static std::string GetTypeString() { return "VistaOpenALRecordTypeTranscoder"; }
	};
	...
	class VistaFormatTranscode : public IVistaMeasureTranscode::TTranscodeValueGet<std::string>
	{
		...
		{
			const VistaOpenALRecordDriver::_audiotype *m = (*pMeasure).getRead<VistaOpenALRecordDriver::_audiotype>();
	...
	static IVistaPropertyGetFunctor *SaGetter[] =
	{
		...
		new VistaFormatTranscode,
		new VistaFrequencyTranscode,
		new VistaMeasureSizeTranscode,
		NULL
	};
	...
	public:
		virtual IVistaMeasureTranscoderFactory *CreateFactoryForType( const std::string &strTypeName )
		{
			...
			{
				return new TDefaultTranscoderFactory<VistaOpenALRecordAudioTranscoder>( VistaOpenALRecordAudioTranscoder::GetTypeString() );
			}
			else if( VistaAspectsComparisonStuff::StringCaseInsensitiveEquals( strTypeName, "TYPE" ) )
			{
				return new TDefaultTranscoderFactory<VistaOpenALRecordTypeTranscoder>( VistaOpenALRecordTypeTranscoder::GetTypeString() );
			}
			else
				return NULL;
		}
		...
		{
			TDefaultTranscoderFactory<VistaOpenALRecordTypeTranscoder>  a( VistaOpenALRecordTypeTranscoder::GetTypeString() ); a.OnUnload();
			TDefaultTranscoderFactory<VistaOpenALRecordAudioTranscoder>  b( VistaOpenALRecordAudioTranscoder::GetTypeString() ); b.OnUnload();
		}
...
#if VISTAOPENALRECORDTRANSCODER_EXPORTS
