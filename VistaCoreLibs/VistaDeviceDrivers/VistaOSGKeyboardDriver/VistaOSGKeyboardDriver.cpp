...
/*                                                                            */
/*============================================================================*/
// $Id: VistaOSGKeyboardDriver.cpp 29146 2012-02-08 15:13:47Z dr165799 $
...
bool InterpreteOSGKey( int& nKey, const int nMod )
{
	switch( nKey )
	{
		...
		case osgGA::GUIEventAdapter::KEY_Tab:
			nKey = VISTA_KEY_TAB; break;
		case osgGA::GUIEventAdapter::KEY_Linefeed:
			nKey = VISTA_KEY_ENTER; break;
		...
		case osgGA::GUIEventAdapter::KEY_Escape:
			nKey = VISTA_KEY_ESC; break;
		case osgGA::GUIEventAdapter::KEY_Delete:
			nKey = VISTA_KEY_DELETE; break;


        /* Cursor control & motion */

		case osgGA::GUIEventAdapter::KEY_Home:
			nKey = VISTA_KEY_HOME; break;
		case osgGA::GUIEventAdapter::KEY_Left:
			nKey = VISTA_KEY_LEFTARROW; break;
		case osgGA::GUIEventAdapter::KEY_Up:
			nKey = VISTA_KEY_UPARROW; break;
		case osgGA::GUIEventAdapter::KEY_Right:
			nKey = VISTA_KEY_RIGHTARROW; break;
		case osgGA::GUIEventAdapter::KEY_Down:
			nKey = VISTA_KEY_DOWNARROW; break;
        //case osgGA::GUIEventAdapter::KEY_Prior           = 0xFF55,        /* Prior, previous */
		case osgGA::GUIEventAdapter::KEY_Page_Up:
			nKey = VISTA_KEY_PAGEUP; break;
        //case osgGA::GUIEventAdapter::KEY_Next            = 0xFF56,        /* Next */
		case osgGA::GUIEventAdapter::KEY_Page_Down:
			nKey = VISTA_KEY_PAGEDOWN; break;
		case osgGA::GUIEventAdapter::KEY_End:
			nKey = VISTA_KEY_END; break;
        ...
        //case osgGA::GUIEventAdapter::KEY_Menu            = 0xFF67,        /* On Windows, this is VK_APPS, the context-menu case osgGA::GUIEventAdapter::KEY */
        //case osgGA::GUIEventAdapter::KEY_Find            = 0xFF68,        /* Find, search */
        //case osgGA::GUIEventAdapter::KEY_Cancel          = 0xFF69,        /* Cancel, stop, abort, exit */
        ...
        /* case osgGA::GUIEventAdapter::KEYpad Functions, case osgGA::GUIEventAdapter::KEYpad numbers cleverly chosen to map to ascii */
         ...
         * function case osgGA::GUIEventAdapter::KEYs;  Sun case osgGA::GUIEventAdapter::KEYboards and a few other manufactures have such
         * function case osgGA::GUIEventAdapter::KEY groups on the left and/or right sides of the case osgGA::GUIEventAdapter::KEYboard.
         * We've not found a case osgGA::GUIEventAdapter::KEYboard with more than 35 function case osgGA::GUIEventAdapter::KEYs total.
         */
		...
		default:
		{
			vstr::warnp() << "OSGKEyboardDriver: Cannot interpret key ["
				<< nKey << "]" << std::endl;
			return false;
		}
	}
...
VistaOSGKeyboardDriverCreationMethod::VistaOSGKeyboardDriverCreationMethod(IVistaTranscoderFactoryFactory *fac)
...
public:
	...
	bool AttachSequence( const VistaDriverAbstractWindowAspect::WindowHandle& oHandle )
	{
		...
		if( m_pKeyboardDriver->RegisterWindow( oHandle.GetWindow() ) == false )
			return false;
...
bool VistaOSGKeyboardDriver::DoSensorUpdate(VistaType::microtime dTs)
{
	...
	for( TemporaryKeyList::const_iterator itKey = vecKeys.begin();
			itKey != vecKeys.end(); ++itKey )
	{		
