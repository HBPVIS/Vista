...
/*                                                                            */
/*============================================================================*/
// $Id: VistaWiimoteDriver.cpp 5686 2010-12-06 09:56:02Z dominikrausch $
...
namespace
{
	...
	public:
			...
			unsigned int nIndex ) const
		{
			...
			_wiimoteMeasure *m
				= (_wiimoteMeasure*)&(*pMeasure).m_vecMeasures[0];
	...
	public:
		...
		virtual bool GetValue(const VistaSensorMeasure *pMeasure, bool &nBtn) const
		{
			...
			const _wiimoteMeasure *m
				= reinterpret_cast<const _wiimoteMeasure*>(&(*pMeasure).m_vecMeasures[0]);
	...
	public:
		...
		bool GetValue( const VistaSensorMeasure *pMeasure, float &nValue ) const
		{
			...
			const _wiistateMeasure *m
				= reinterpret_cast<const _wiistateMeasure*>(&(*pMeasure).m_vecMeasures[0]);
...
#if VISTAWIIMOTETRANSCODER_EXPORTS
