...
/*                                                                            */
/*============================================================================*/
// $Id: VistaCHAI3DHapticDevicesDriverPlugin.cpp 5427 2010-07-23 15:45:53Z tbeer $
...
namespace
{
	...
	class VistaCHAI3DHapticDevicesPosTranscode : public IVistaMeasureTranscode::CV3Get
	{
	public:
	...
	class VistaCHAI3DHapticDevicesVelocityTranscode : public IVistaMeasureTranscode::CV3Get
	{
	public:
	...
	class VistaCHAI3DHapticDevicesForceReadTranscode : public IVistaMeasureTranscode::CV3Get
	{
	public:
	...
	class VistaCHAI3DHapticDevicesScalarTranscode : public IVistaMeasureTranscode::CScalarDoubleGet
	{
	public:
	...
	class VistaCHAI3DHapticDevicesRotationGet : public IVistaMeasureTranscode::CQuatGet
	{
	public:
	...
	class VistaCHAI3DHapticDevicesVecFieldGet : public IVistaMeasureTranscode::CV3Get
	{
	public:
		enum eField
		{
...
#if VISTACHAI3DHAPTICDEVICESTRANSCODER_EXPORTS
