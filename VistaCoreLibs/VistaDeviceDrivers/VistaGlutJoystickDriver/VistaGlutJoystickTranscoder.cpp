...
namespace
{
	...
	class VistaJoystickPositionTranscode : public IVistaMeasureTranscode::CV3Get
	{
	public:
	...
	class VistaJoystickOrientationTranscode : public IVistaMeasureTranscode::CQuatGet
	{
	public:
	...
	class VistaJoystickScalarTranscode : public IVistaMeasureTranscode::CScalarDoubleGet
	{
	public:
...
#if VISTAGLUTJOYSTICKTRANSCODER_EXPORTS
