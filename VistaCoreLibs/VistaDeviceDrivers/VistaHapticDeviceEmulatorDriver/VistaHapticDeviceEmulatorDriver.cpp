...
/*                                                                            */
/*============================================================================*/
// $Id: VistaHapticDeviceEmulatorDriver.cpp 23585 2011-09-28 07:44:46Z dr165799 $
...
class VistaHapticDeviceEmulatorControlAttachSequence : public VistaDriverConnectionAspect::IVistaConnectionSequence
{
public:
...
class VistaHapticDeviceEmulatorAttachSequence : public VistaDriverConnectionAspect::IVistaConnectionSequence
{
public:
	virtual bool operator()(VistaConnection *pCon)
	{
...
class VistaHapticDeviceEmulatorControlDetachSequence : public VistaDriverConnectionAspect::IVistaConnectionSequence
{
public:
	virtual bool operator()(VistaConnection *pCon)
	{
  ...
  m_maxForce(0.0f), m_maxStiffness(0.0f)
{
	...
	m_pConAspect->SetAttachSequence( CONTROLCHANNEL, new VistaHapticDeviceEmulatorControlAttachSequence(this) );
	m_pConAspect->SetDetachSequence( CONTROLCHANNEL, new VistaHapticDeviceEmulatorControlDetachSequence );
	...
	try
	{
		...
		if(pIncoming && pIncoming->GetIsOpen())
		{
			...
			if(nReadSize > 0)
			{
				...
				{
					nDataRead = pIncoming->ReadRawBuffer((void*)&msg[0], sizeof(VistaHapticDeviceEmulatorMeasures::sHapticDeviceEmulatorMeasure));
					if(nDataRead < 0)
					{
						// TROUBLE!
				...
				VistaHapticDeviceEmulatorMeasures::sHapticDeviceEmulatorMeasure *m = (VistaHapticDeviceEmulatorMeasures::sHapticDeviceEmulatorMeasure*)(&(*pM).m_vecMeasures[0]);
...
void	VistaHapticDeviceEmulatorDriver::GetMaxWorkspace(VistaVector3D & min, VistaVector3D & max) const
{
	min = m_maxWorkspaceMin;
	max = m_maxWorkspaceMax;
}

void	VistaHapticDeviceEmulatorDriver::GetMaxUsableWorkspace(VistaVector3D & min, VistaVector3D & max) const
{
...
VistaHapticDeviceEmulatorDriver::VistaHapticDeviceEmulatorForceFeedbackAspect::VistaHapticDeviceEmulatorForceFeedbackAspect( VistaHapticDeviceEmulatorDriver *pDriver )
...
VistaHapticDeviceEmulatorDriver::VistaHapticDeviceEmulatorForceFeedbackAspect::~VistaHapticDeviceEmulatorForceFeedbackAspect()
{
	delete m_pSerializer;
}

bool VistaHapticDeviceEmulatorDriver::VistaHapticDeviceEmulatorForceFeedbackAspect::SetForce( const VistaVector3D   & v3Force,
...
bool VistaHapticDeviceEmulatorDriver::VistaHapticDeviceEmulatorForceFeedbackAspect::SetConstraint( const VistaVector3D		& contactPoint,
...
bool VistaHapticDeviceEmulatorDriver::VistaHapticDeviceEmulatorForceFeedbackAspect::SetForcesEnabled(bool bEnabled)
{
...
bool VistaHapticDeviceEmulatorDriver::VistaHapticDeviceEmulatorForceFeedbackAspect::SetDynamicFrictionEnabled( bool bEnabled )
{
...
bool VistaHapticDeviceEmulatorDriver::VistaHapticDeviceEmulatorForceFeedbackAspect::GetDynamicFrictionEnabled() const
{
	return m_bDynamicFriction;
}

bool VistaHapticDeviceEmulatorDriver::VistaHapticDeviceEmulatorForceFeedbackAspect::GetForcesEnabled() const
{
	return m_bForcesEnabled;
}

VistaConnection *VistaHapticDeviceEmulatorDriver::VistaHapticDeviceEmulatorForceFeedbackAspect::GetChannel(int nIdx) const
{
	if(m_pParent)
	{
...
int VistaHapticDeviceEmulatorDriver::VistaHapticDeviceEmulatorForceFeedbackAspect::GetNumInputDOF() const
{
	return m_pParent->m_inputDOF;
}

int VistaHapticDeviceEmulatorDriver::VistaHapticDeviceEmulatorForceFeedbackAspect::GetNumOutputDOF() const
{
	return m_pParent->m_outputDOF;
}

float VistaHapticDeviceEmulatorDriver::VistaHapticDeviceEmulatorForceFeedbackAspect::GetMaximumStiffness() const
{
    return m_pParent->m_maxStiffness;
}

float VistaHapticDeviceEmulatorDriver::VistaHapticDeviceEmulatorForceFeedbackAspect::GetMaximumForce() const
{
