...
/*                                                                            */
/*============================================================================*/
// $Id: VistaHapticDeviceEmulatorDriver.cpp 19790 2010-10-26 20:21:11Z ingoassenmacher $
...
namespace
{
	...
	public:
		...
		static std::string GetTypeString() { return "VistaHapticDeviceEmulatorDriverMeasureTranscode"; }
		REFL_INLINEIMP(VistaHapticDeviceEmulatorDriverMeasureTranscode, IVistaMeasureTranscode);
	};

	class VistaHapticDeviceEmulatorPosTranscode : public IVistaMeasureTranscode::CV3Get
	{
	public:
		...
		{
			VistaHapticDeviceEmulatorMeasures::sHapticDeviceEmulatorMeasure *m = (VistaHapticDeviceEmulatorMeasures::sHapticDeviceEmulatorMeasure*)&(*pMeasure).m_vecMeasures[0];
	...
	class VistaHapticDeviceEmulatorPosSCPTranscode : public IVistaMeasureTranscode::CV3Get
	{
	public:
	...
	class VistaHapticDeviceEmulatorVelocityTranscode : public IVistaMeasureTranscode::CV3Get
	{
	public:
	...
	class VistaHapticDeviceEmulatorForceReadTranscode : public IVistaMeasureTranscode::CV3Get
	{
	public:
	...
	class VistaHapticDeviceEmulatorScalarTranscode : public IVistaMeasureTranscode::CScalarDoubleGet
	{
	public:
	...
	class VistaHapticDeviceEmulatorRotationGet : public IVistaMeasureTranscode::CQuatGet
	{
	public:
	...
	{
		new VistaHapticDeviceEmulatorPosTranscode,
		new VistaHapticDeviceEmulatorForceReadTranscode,
		new VistaHapticDeviceEmulatorScalarTranscode,
		new VistaHapticDeviceEmulatorPosSCPTranscode,
		new VistaHapticDeviceEmulatorVelocityTranscode,
		new VistaHapticDeviceEmulatorRotationGet,
		NULL
	};
}
...
class VistaHapticDeviceEmulatorTranscoderFactory : public TDefaultTranscoderFactory<VistaHapticDeviceEmulatorDriverMeasureTranscode>
{
public:
	VistaHapticDeviceEmulatorTranscoderFactory()
		: TDefaultTranscoderFactory<VistaHapticDeviceEmulatorDriverMeasureTranscode>(VistaHapticDeviceEmulatorDriverMeasureTranscode::GetTypeString())
	{}
};

#if VISTAHAPTICDEVICEEMULATORTRANSCODER_EXPORTS
DEFTRANSCODERPLUG_FUNC_EXPORTS( TSimpleTranscoderFactoryFactory<VistaHapticDeviceEmulatorTranscoderFactory> )
#else
DEFTRANSCODERPLUG_FUNC_IMPORTS( TSimpleTranscoderFactoryFactory<VistaHapticDeviceEmulatorTranscoderFactory> )
#endif

DEFTRANSCODERPLUG_CLEANUP;
IMPTRANSCODERPLUG_CLEANUP(TSimpleTranscoderFactoryFactory<VistaHapticDeviceEmulatorTranscoderFactory>)
