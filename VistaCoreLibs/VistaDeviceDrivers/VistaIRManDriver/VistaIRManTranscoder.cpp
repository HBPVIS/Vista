...
namespace
{
	...
	public:
		...
		{
			const VistaIRManDriver::_sIRManSample *s = (*m).getRead<VistaIRManDriver::_sIRManSample>(); //(VistaIRManDriver::_sIRManSample*)(&((*m).m_vecMeasures[0]));
			return *s;
		}
...
#if VISTAIRMANTRANSCODER_EXPORTS
