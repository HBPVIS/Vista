...
/*============================================================================*/
class VistaTranscode : public IVistaMeasureTranscode
{
public:
	VistaTranscode()
	{
	...
	static std::string GetTypeString() { return "VistaTranscode"; }
	REFL_INLINEIMP(VistaTranscode, IVistaMeasureTranscode);
};
...
IVistaDeviceDriver *VistaSpaceNavigatorCreationMethod::operator()()
{
	return new VistaSpaceNavigator;
}
	...
	: IVistaDeviceDriver()
{
	...
	// TODO: define transcode
	pSensor->SetMeasureTranscode( new VistaTranscode );
...
bool VistaSpaceNavigator::DoSensorUpdate(microtime dTs)
{
	// TODO: check
	bool bNewState = true;
...
unsigned int VistaSpaceNavigator::GetSensorMeasureSize() const
{
