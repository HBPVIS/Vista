...
#include "VistaJswJoystickDriverPlugin.h"
...
{
	return VistaJswJoystickDriver::GetDriverFactoryMethod();
}
...
extern "C" VISTAJSWJOYSTICKPLUGINAPI void Unload(IVistaDriverCreationMethod *pMt)
{
	pMt->OnUnload();
}
/*============================================================================*/
