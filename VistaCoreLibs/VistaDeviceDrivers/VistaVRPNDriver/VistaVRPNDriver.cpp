...
{
	RegisterSensorType( "ANALOG",
									 sizeof(_vrpn_ANALOGCB),
									 100, fac->CreateFactoryForType("ANALOG") );
	RegisterSensorType( "BUTTON",
									 sizeof(_vrpn_BUTTONCB),
									 100, fac->CreateFactoryForType("BUTTON") );
	RegisterSensorType( "TRACKER",
									 sizeof(_vrpn_TRACKERCB),
									 100, fac->CreateFactoryForType("TRACKER") );
}
...
namespace
{
	...
	template<class T> void recordData( IVistaDeviceDriver *pDriver,
			                           ...
			                           VistaType::microtime nUpdateTime,
			                           const T &data )
	{
