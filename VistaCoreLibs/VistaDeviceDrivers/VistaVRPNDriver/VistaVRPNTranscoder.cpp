...
namespace
{
	...
	public:
		...
		static std::string GetTypeString() { return "VRPNTranscoder"; }
	};
	...
	public:
		...
		static std::string GetTypeString() { return "VRPNAnalogTranscoder"; }
	};
	...
	public:
		...
		static std::string GetTypeString() { return "VRPNButtonTranscoder"; }
	};
	...
	public:
		...
		static std::string GetTypeString() { return "VRPNTrackerTranscoder"; }
	};
	...
	public:
		VRPNTimeStampGet()
		: IVistaMeasureTranscode::TTranscodeValueGet<VistaType::microtime>(
				   "VRPN_TIMECODE", VRPNTranscoder::GetTypeString(),
	...
	class VRPNAnalogValueGet : public IVistaMeasureTranscode::CScalarDoubleGet
	{
	public:
		VRPNAnalogValueGet()
	...
	class VRPNAnalogChannelGet : public IVistaMeasureTranscode::CUIntGet
	{
	public:
		VRPNAnalogChannelGet()
		: IVistaMeasureTranscode::CUIntGet("CHANNELS", VRPNAnalogTranscoder::GetTypeString(),
	...
	class VRPNAnalogChannelBlindGet : public IVistaMeasureTranscode::TTranscodeValueGet< std::vector<double> >
	{
	public:
	...
	class VRPNButtonValueGet : public IVistaMeasureTranscode::CUIntGet
	{
	public:
		VRPNButtonValueGet()
	...
	class VRPNButtonNumberGet : public IVistaMeasureTranscode::CUIntGet
	{
	public:
		VRPNButtonNumberGet()
	...
	class VRPNButtonMaskGet : public IVistaMeasureTranscode::CUIntGet
	{
	public:
		VRPNButtonMaskGet()
	...
	class VRPNSensorNumberGet : public IVistaMeasureTranscode::CUIntGet
	{
	public:
		VRPNSensorNumberGet()
	...
	class VRPNSensorPositionGet : public IVistaMeasureTranscode::CV3Get
	{
	public:
	...
	class VRPNSensorOrientationGet : public IVistaMeasureTranscode::CQuatGet
	{
	public:
	...
	{
		new VRPNTimeStampGet,
		new VRPNAnalogValueGet,
		new VRPNAnalogChannelBlindGet,
		new VRPNAnalogChannelGet,

		new VRPNButtonValueGet,
		new VRPNButtonNumberGet,
		new VRPNButtonMaskGet,

		new VRPNSensorNumberGet,
		new VRPNSensorPositionGet,
		new VRPNSensorOrientationGet,
	...
	public:
		virtual IVistaMeasureTranscoderFactory *CreateFactoryForType( const std::string &strTypeName )
		{
			...
			{
				return new TDefaultTranscoderFactory<VRPNAnalogTranscoder>( VRPNAnalogTranscoder::GetTypeString() );
			}
			else if( VistaAspectsComparisonStuff::StringCaseInsensitiveEquals( strTypeName, "BUTTON" ) )
			{
				return new TDefaultTranscoderFactory<VRPNButtonTranscoder>( VRPNButtonTranscoder::GetTypeString() );
			}
			else if( VistaAspectsComparisonStuff::StringCaseInsensitiveEquals( strTypeName, "TRACKER" ) )
			{
				return new TDefaultTranscoderFactory<VRPNTrackerTranscoder>( VRPNTrackerTranscoder::GetTypeString() );
			}
			else
				return NULL;
		}
		...
		{
			TDefaultTranscoderFactory<VRPNAnalogTranscoder>  a( VRPNAnalogTranscoder::GetTypeString() ); a.OnUnload();
			TDefaultTranscoderFactory<VRPNButtonTranscoder>  b( VRPNButtonTranscoder::GetTypeString() ); b.OnUnload();
			TDefaultTranscoderFactory<VRPNTrackerTranscoder> t(VRPNTrackerTranscoder::GetTypeString() ); t.OnUnload();
		}
	};
...
#if VISTAVRPNTRANSCODER_EXPORTS
