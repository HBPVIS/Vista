...
namespace
{
	...
	public:
		...
		{
			VistaFastrakMeasures::sFastrakSample *m = (VistaFastrakMeasures::sFastrakSample*)&(*pMeasure).m_vecMeasures[0];
	...
	public:
		...
		{
			VistaFastrakMeasures::sFastrakButtonSample *m = (VistaFastrakMeasures::sFastrakButtonSample*)&(*pMeasure).m_vecMeasures[0];
			bRet = m->m_bBtPress;
			return true;
		}
	};
...
#if VISTAFASTRAKTRANSCODER_EXPORTS
