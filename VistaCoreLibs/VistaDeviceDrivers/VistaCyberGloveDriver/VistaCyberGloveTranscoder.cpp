...
/*                                                                            */
/*============================================================================*/
// $Id: VistaCyberGloveDriver.cpp 20121 2011-01-29 20:42:19Z ingoassenmacher $
...
public:
	...
	virtual std::string GetTranscoderName() const { return VistaCyberGloveDriverTranscode::GetTypeString(); }
};

class VistaCyberGloveRawSampleGet : public IVistaMeasureTranscode::TTranscodeValueGet<VistaCyberGloveCommonShare::sCyberGloveSample>
{
public:
	VistaCyberGloveRawSampleGet( const std::string &sPropName,
		const std::string &sClassName,
		const std::string &sDescription)
		: IVistaMeasureTranscode::TTranscodeValueGet<VistaCyberGloveCommonShare::sCyberGloveSample>(sPropName, sClassName, sDescription)
	{}

	virtual VistaCyberGloveCommonShare::sCyberGloveSample GetValue(const VistaSensorMeasure *m)    const
	{
		VistaCyberGloveCommonShare::sCyberGloveSample *s = (VistaCyberGloveCommonShare::sCyberGloveSample*)(&((*m).m_vecMeasures[0]));
		return *s;
	}

	virtual bool GetValue(const VistaSensorMeasure *m, VistaCyberGloveCommonShare::sCyberGloveSample &out) const
	{
		out = GetValue(m);
		return true;
	}
...
{
public:
	VistaCyberGloveSensorDataGet( const std::string &sPropName,
		const std::string &sClassName,
		const std::string &sDescription)
...
{
public:
	VistaCyberGloveNumSensorsGet( const std::string &sPropName,
		const std::string &sClassName,
		const std::string &sDescription)
...
{
public:
	VistaCyberGloveTimestampGet( const std::string &sPropName,
		const std::string &sClassName,
		const std::string &sDescription)
...
class VistaCyberGloveSensorVectorGet : public IVistaMeasureTranscode::TTranscodeValueGet< std::vector<unsigned int> >
{
public:
	VistaCyberGloveSensorVectorGet( const std::string &sPropName,
		const std::string &sClassName,
		const std::string &sDescription )
		: IVistaMeasureTranscode::TTranscodeValueGet< std::vector<unsigned int> >(sPropName, sClassName, sDescription)
	{
	}
...
{
public:
	VistaCyberGloveStatusByteGet( const std::string &sPropName,
		const std::string &sClassName,
		const std::string &sDescription)
		: IVistaMeasureTranscode::TTranscodeValueGet<int>(sPropName, sClassName, sDescription)
	{}
...
{
public:
	VistaCyberGloveLightStateGet( const std::string &sPropName,
		const std::string &sClassName,
		const std::string &sDescription)
		: IVistaMeasureTranscode::TTranscodeValueGet<int>(sPropName, sClassName, sDescription)
	{}
...
{
public:
	VistaCyberGloveSwitchStateGet( const std::string &sPropName,
		const std::string &sClassName,
		const std::string &sDescription)
		: IVistaMeasureTranscode::TTranscodeValueGet<int>(sPropName, sClassName, sDescription)
	{}
...
#if VISTACYBERGLOVETRANSCODER_EXPORTS
