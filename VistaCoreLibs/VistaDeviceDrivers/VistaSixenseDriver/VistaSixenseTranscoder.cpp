...
namespace
{
	...
	class VistaSixensePosGet : public IVistaMeasureTranscode::CV3Get
	{
	public:
		VistaSixensePosGet( const std::string& sTranscodeName )
		: IVistaMeasureTranscode::CV3Get( "POSITION", sTranscodeName, "position" )
		{
		}
	...
	class VistaSixenseOriGet : public IVistaMeasureTranscode::CQuatGet
	{
	public:
		VistaSixenseOriGet( const std::string& sTranscodeName )
		: IVistaMeasureTranscode::CQuatGet( "ORIENTATION", sTranscodeName, "orientation" ) {}
...
#if VISTASIXENSETRANSCODER_EXPORTS
