...
if [ "$2" = "" ]; then
	echo "No slave configuration given."
	exit -4	
fi
...
$EXECUTABLE -clusterslave $2 -vistaini vista_cave.ini -interactionini interaction_cave -displayini display_cave.ini -clusterini display_cave.ini
