...
int	main (int argc, char *argv[])
{
	...
	{	
		 ...
		 * our ActionObject.
		 */
		pVistaSystem->GetDfnObjectRegistry()->SetObject( "SpherePosition",
										new SetPositionActionObject( pGeomTrans ), NULL ); 
		 ...
		 */
		pVistaSystem->GetDfnObjectRegistry()->SetObject( "SphereColor",
										new ApplyColorActionObject( pGeometry ), NULL );		
		...
		/**
		 * PyDfnNode allows you to implement DFN nodes using python. Requires one parameter, the path to the script.
		 *
		 */
